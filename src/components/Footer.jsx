      ...
      <div className="Foot-nav">
        ...
        <Uldiv>
          <Mainul style={{ textAlign: "center" }}>
            ...
            <li>Career</li>
            <li>
              <Link to="/OurTeam">Leadership</Link>
            </li>
            <li>Mentors</li>
            <li>Contact us</li>
          </Mainul>
        ...
        <div>
          <Mainul style={{ textAlign: "center" }}>
            ...
            <Socialli>
              <Socialdiv>
                <a href="https://www.facebook.com/nupattechnologies/">
                  <FaceBook type="image" src={Facebook} />
                </a>
                <a href="https://www.linkedin.com/company/nupat-technologies/">
                  <Linkedinn type="image" src={Linkedin} />
                </a>
                <a href="https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=user_system_sheet&utm_content=nkedc9z">
                  {" "}
