  ...
  <div>
    ...
    <div className="FormContainer">
       ...
       <h1 style={{textAlign:'center'}}>Courses</h1>
        ...
        <p style={{textAlign:'justify'}}>Enroll to our Backend/API software development program and get practical guide, courses and mentorship from beginner to intermediate level. The technologies covered in this program includes HTML/CSS Frontend technologies, Vanilla JavaScript, Source Control with Git,  NodeJS NPM, and NoSQL Database (MongoDB), Column Databases, Database ORM, Express Framework, Asynchronous programming, Karken layer, Drywall user management, Bcrypt encryption, Socket IO and REST APIs. <SpanContent onClick={onClick2}>{!showText2 && 'Read more...'}</SpanContent> {showText2? <span>
      ...
      <p style={{textAlign:'justify'}}>Enroll to our Blockchain software development program and get practical guide, courses and mentorship from beginner to intermediate level. The technologies covered in this program includes HTML/CSS Frontend technologies, Vanilla JavaScript, Source Control with Git, Ethereum Blockchain Development with Solidity, Web3.JS, Truffle, Metamask, Remix & More.. <SpanContent onClick={onClick3}>{!showText3 && 'Read more...'}</SpanContent>  {showText3?  <span>
      ...
      <div className='enroll'>
        ...
        <div className="TextContent">
          ...
          <p style={{textAlign:'justify'}}>Enroll to our Blockchain software development program and get practical guide, courses and mentorship from beginner to intermediate level. The technologies covered in this program includes HTML/CSS Frontend technologies, Vanilla JavaScript, Source Control with Git, Ethereum Blockchain Development with Solidity, Web3.JS, Truffle, Metamask, Remix & More.. <SpanContent onClick={onClick5}>{!showText5 && 'Read more...'}</SpanContent>
          {showText5? <span>
        ...
        <a href="https://extendedforms.io/form/969c7463-330e-4147-9ba8-8725f542a77b/login" >Enroll Now</a>
          ...
          <p style={{textAlign:'justify'}}>Enroll to our Full-stack software development program and get practical guide, courses and mentorship from beginner to intermediate level. The technologies covered in this program includes HTML/CSS Frontend technologies, Vanilla JavaScript, Source Control with Git, ReactJS, Redux, Hooks & Context, NodeJS NPM, and NoSQL Database (MongoDB), Column Databases, Database ORM, Express Framework, Asynchronous programming, Karken layer, Drywall user management, Bcrypt encryption, Socket IO and REST APIs. <SpanContent onClick={onClick6}>{!showText6 && 'Read more...'}</SpanContent>
          ...
          We will use in demand tools like Figma to show you a full workflow from start to finish. From sketching, inspiration, prototyping, wireframes to microinteractions etc, we will guide and equip you to become confident and ready to deliver as a professional Designer. <SpanContent onClick={onClick7}>{!showText7 && 'Read more...'}</SpanContent> 
          {showText7?  <span>
          ...
          <p style={{textAlign:'justify'}}>Enroll to our Data Science and Analytics training program and get practical guide, courses and mentorship from beginner to intermediate level. The technologies covered in this program includes Microsoft Power Bi, Microsoft Excel, SQL Database, Python & More. <SpanContent onClick={onClick8}>{!showText7 && 'Read more...'}</SpanContent> 
